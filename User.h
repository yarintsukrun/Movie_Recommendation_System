...
private:
	...
	rank_map _user_ranked_movie_list;
	std::shared_ptr<RecommendationSystem> _shared_recommand_system;
...
public:
	...
	User(std::string& username, rank_map map,
		std::shared_ptr<RecommendationSystem> shared);
	 ...
	 */
	double get_rs_prediction_score_for_movie
